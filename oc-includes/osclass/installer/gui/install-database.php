        ...
        <div class="accordion mb-3" id="accordianAdvance">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingAdvance">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAdvance" aria-expanded="false" aria-controls="accordianAdvance">
                        <?php _e('Advanced'); ?>
                    </button>
                </h2>
                    ...
                    <div class="accordion-body">
                        <div class="row mb-3">
                            <div class="col-md-8 col-sm-12">
                                <input type="checkbox" id="createdb" name="createdb" onclick="db_admin();" value="1" />
                        ...
                        <div id="admin_username_row" class="row mb-3">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <input class="form-control" type="text" id="admin_username" name="admin_username" size="25" disabled="disabled" />
                            </div>
                        </div>
                        <div id="admin_password_row" class="row mb-3">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <input class="form-control" type="password" id="admin_password" name="admin_password" value="" size="25" disabled="disabled" autocomplete="off" />
