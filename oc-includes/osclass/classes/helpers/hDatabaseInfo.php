...
class hDatabaseInfo
{
     ...
     * @return string
     */
    public static function osc_db_name()
    {
     ...
     * @return string
     */
    public static function osc_db_host()
    {
     ...
     * @return string
     */
    public static function osc_db_user()
    {
     ...
     * @return string
     */
    public static function osc_db_password()
    {
     ...
     * @return string
     */
    public static function osc_multisite_url()
    {
     ...
     * @return string
     */
    public static function osc_multisite_upload_path()
    {
...
//PRIVATE FUNCTION FOR GETTING NO BOOLEAN INFORMATION (if there was a class :P)
     ...
     * @return string
     */
    public static function getSiteInfo($key, $default_value)
    {
        if (MULTISITE) {
