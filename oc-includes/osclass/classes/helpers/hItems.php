...
////////////////////////////////////////////////////////////////
     ...
     */
    public static function osc_item()
    {
     ...
     */
    public static function osc_comment()
    {
     ...
     */
    public static function osc_resource()
    {
     ...
     * @return string
     */
    public static function osc_item_field($field, $locale = '')
    {
     ...
     * @return string
     */
    public static function osc_comment_field($field, $locale = '')
    {
     ...
     * @return string
     */
    public static function osc_resource_field($field, $locale = '')
    {
...
///////////////////////
     ...
     * @return int
     */
    public static function osc_item_id()
    {
     ...
     * @return int
     */
    public static function osc_item_user_id()
    {
     ...
     * @return string $desc
     */
    public static function osc_item_description($locale = '')
    {
        if ($locale == '') {
     ...
     * @return string
     */
    public static function osc_item_title($locale = '')
    {
        if ($locale == '') {
            $locale = osc_current_user_locale();
        }
     ...
     * @return string
     */
    public static function osc_item_category($locale = '')
    {
     ...
     * @return string
     */
    public static function osc_item_category_description($locale = '')
    {
        if (!View::newInstance()->_exists('item_category')) {
            View::newInstance()->_exportVariableToView(
                'item_category',
     ...
     * @return int
     */
    public static function osc_item_category_id()
    {
     ...
     * @return string
     */
    public static function osc_item_category_price_enabled($catId = null)
    {
        if ($catId == null) {
     ...
     * @return string
     */
    public static function osc_item_pub_date()
    {
     ...
     * @return string
     */
    public static function osc_item_mod_date()
    {
     ...
     * @return string
     */
    public static function osc_item_dt_expiration()
    {
     ...
     * @return float
     */
    public static function osc_item_price()
    {
     ...
     * @return string
     */
    public static function osc_item_formatted_price()
    {
     ...
     * @return string
     */
    public static function osc_item_formated_price()
    {
     ...
     * @return string
     */
    public static function osc_item_currency()
    {
     ...
     * @since 3.0
     */
    public static function osc_item_currency_symbol()
    {
     ...
     * @return string
     */
    public static function osc_item_contact_name()
    {
     ...
     * @return string
     */
    public static function osc_item_contact_email()
    {
     ...
     * @return string
     */
    public static function osc_item_contact_phone()
    {
     ...
     * @return string
     */
    public static function osc_item_country()
    {
     ...
     * @return string
     */
    public static function osc_item_country_code()
    {
     ...
     * @return string
     */
    public static function osc_item_region()
    {
     ...
     * @return string
     */
    public static function osc_item_region_id()
    {
     ...
     * @return string
     */
    public static function osc_item_city()
    {
     ...
     * @return string
     */
    public static function osc_item_city_id()
    {
     ...
     * @return string
     */
    public static function osc_item_city_area()
    {
     ...
     * @return string
     */
    public static function osc_item_city_area_id()
    {
     ...
     * @return string
     */
    public static function osc_item_address()
    {
     ...
     * @return boolean
     */
    public static function osc_item_show_email()
    {
     ...
     * @return string
     */
    public static function osc_item_zip()
    {
     ...
     * @return float
     */
    public static function osc_item_latitude()
    {
     ...
     * @return float
     */
    public static function osc_item_longitude()
    {
     ...
     * @return string
     */
    public static function osc_item_ip()
    {
     ...
     * @return boolean
     */
    public static function osc_item_is_premium()
    {
     ...
     * @return int
     */
    public static function osc_item_views($viewAll = false)
    {
        $item = osc_item();
        if ($viewAll) {
     ...
     * @return boolean
     */
    public static function osc_item_is_expired()
    {
     ...
     * @return boolean
     */
    public static function osc_item_status()
    {
     ...
     * @return string
     */
    public static function osc_item_secret()
    {
     ...
     * @return boolean
     */
    public static function osc_item_is_active()
    {
     ...
     * @return boolean
     */
    public static function osc_item_is_inactive()
    {
     ...
     * @return boolean
     */
    public static function osc_item_is_enabled()
    {
     ...
     * @return boolean
     */
    public static function osc_item_is_spam()
    {
     ...
     * @return string
     */
    public static function osc_item_link_spam()
    {
     ...
     * @return string
     */
    public static function osc_item_link_bad_category()
    {
        if (!osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_item_link_repeated()
    {
        if (!osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_item_link_offensive()
    {
        if (!osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_item_link_expired()
    {
        if (!osc_rewrite_enabled()) {
...
// DEPRECATED: This function will be removed in version 4.0
     ...
     * @return int
     */
    public static function osc_list_page()
    {
...
// DEPRECATED: This function will be removed in version 4.0
     ...
     * @return int
     */
    public static function osc_list_total_pages()
    {
     ...
     * @return int
     */
    public static function osc_list_items_per_page()
    {
     ...
     * @return int
     */
    public static function osc_item_total_comments()
    {
     ...
     * @return int
     */
    public static function osc_item_comments_page()
    {
...
//////////////////////////
     ...
     * @return int
     */
    public static function osc_comment_id()
    {
     ...
     * @return string
     */
    public static function osc_comment_pub_date()
    {
     ...
     * @return string
     */
    public static function osc_comment_title()
    {
     ...
     * @return string
     */
    public static function osc_comment_author_name()
    {
     ...
     * @return string
     */
    public static function osc_comment_author_email()
    {
     ...
     * @return string
     */
    public static function osc_comment_body()
    {
     ...
     * @return int
     */
    public static function osc_comment_user_id()
    {
     ...
     * @return string
     */
    public static function osc_delete_comment_url()
    {
...
///////////////////////////
     ...
     * @return int
     */
    public static function osc_resource_id()
    {
     ...
     * @return string
     */
    public static function osc_resource_name()
    {
     ...
     * @return string
     */
    public static function osc_resource_type()
    {
     ...
     * @return string
     */
    public static function osc_resource_extension()
    {
     ...
     * @return string
     */
    public static function osc_resource_path()
    {
     ...
     * @return string
     */
    public static function osc_resource_url()
    {
     ...
     * @return string
     */
    public static function osc_resource_thumbnail_url()
    {
        return (string)osc_apply_filter(
     ...
     * @since 2.3.7
     */
    public static function osc_resource_preview_url()
    {
        return (string)osc_apply_filter(
     ...
     * @return string
     */
    public static function osc_resource_original_url()
    {
        return (string)osc_apply_filter(
     ...
     * @since 2.3.6
     */
    public static function osc_reset_resources()
    {
...
/////////////
     ...
     * @return array
     */
    public static function osc_has_items()
    {
        if (View::newInstance()->_exists('resources')) {
     ...
     * @return array
     */
    public static function osc_reset_items()
    {
        View::newInstance()->_exportVariableToView('item', View::newInstance()->_get('oldItem'));
        View::newInstance()->_exportVariableToView('itemLoop', '');
     ...
     * @since 2.4
     */
    public static function osc_reset_latest_items()
    {
        View::newInstance()->_exportVariableToView('item', View::newInstance()->_get('oldItem'));
        View::newInstance()->_exportVariableToView('itemLoop', '');
     ...
     * @return int
     */
    public static function osc_count_items()
    {
     ...
     * @return int
     */
    public static function osc_count_item_resources()
    {
        if (!View::newInstance()->_exists('resources')) {
            View::newInstance()
                ->_exportVariableToView(
                    'resources',
                    ItemResource::newInstance()->getAllResourcesFromItem(osc_item_id())
                );
        }
     ...
     * @return array
     */
    public static function osc_has_item_resources()
    {
        if (!View::newInstance()->_exists('resources')) {
            View::newInstance()
                ->_exportVariableToView(
     ...
     * @return array
     */
    public static function osc_get_item_resources()
    {
        if (!View::newInstance()->_exists('resources')) {
            View::newInstance()
                ->_exportVariableToView(
     ...
     * @return int
     */
    public static function osc_count_item_comments()
    {
        if (!View::newInstance()->_exists('comments')) {
            View::newInstance()->_exportVariableToView(
                'comments',
                ItemComment::newInstance()
                    ->findByItemID(osc_item_id(), osc_item_comments_page(), osc_comments_per_page())
            );
        }
     ...
     * @return array
     */
    public static function osc_has_item_comments()
    {
        if (!View::newInstance()->_exists('comments')) {
            View::newInstance()->_exportVariableToView(
                'comments',
...
//////////
     ...
     */
    public static function osc_has_latest_items($total_latest_items = null, $options = array(), $withPicture = false)
    {
     ...
     * @return int
     */
    public static function osc_count_latest_items($total_latest_items = null, $options = array())
    {
        if (!View::newInstance()->_exists('latestItems')) {
            $search = Search::newInstance();
            if (!is_numeric($total_latest_items)) {
...
//////////////
     ...
     * @return array
     */
    public static function osc_has_custom_items()
    {
        if (View::newInstance()->_exists('resources')) {
            View::newInstance()->_erase('resources');
        }
     ...
     * @return int
     */
    public static function osc_count_custom_items()
    {
     ...
     * @since 2.4
     */
    public static function osc_reset_custom_items()
    {
        View::newInstance()->_exportVariableToView('item', View::newInstance()->_get('oldItem'));
        View::newInstance()->_exportVariableToView('itemLoop', '');
     ...
     * @return string
     */
    public static function osc_format_price($price, $symbol = null)
    {
        if ($price === null) {
     ...
     * @access     private
     */
    public static function osc_priv_count_items()
    {
        return (int)View::newInstance()->_count('items');
    }
     ...
     * @access     private
     */
    public static function osc_priv_count_item_resources()
    {
        return (int)View::newInstance()->_count('resources');
    }
     ...
     * @return integer
     */
    public static function osc_count_item_meta()
    {
        if (!View::newInstance()->_exists('metafields')) {
     ...
     * @return array
     */
    public static function osc_has_item_meta()
    {
        if (!View::newInstance()->_exists('metafields')) {
            View::newInstance()->_exportVariableToView('metafields', Item::newInstance()->metaFields(osc_item_id()));
        }
     ...
     * @return array
     */
    public static function osc_get_item_meta()
    {
        if (!View::newInstance()->_exists('metafields')) {
            View::newInstance()->_exportVariableToView('metafields', Item::newInstance()->metaFields(osc_item_id()));
        }
     ...
     * @return array
     */
    public static function osc_item_meta()
    {
     ...
     * @return string
     */
    public static function osc_item_meta_value()
    {
        $meta  = osc_item_meta();
     ...
     * @return string
     */
    public static function osc_item_meta_name()
    {
     ...
     * @return integer
     */
    public static function osc_item_meta_id()
    {
     ...
     * @return string
     */
    public static function osc_item_meta_slug()
    {
     ...
     * @return string
     */
    public static function osc_total_active_items()
    {
     ...
     * @return string
     */
    public static function osc_total_items()
    {
     ...
     * @return string
     */
    public static function osc_total_active_items_today()
    {
     ...
     * @return string
     */
    public static function osc_total_items_today()
    {
     ...
     * @since 3.0
     */
    public static function osc_query_item($params = null)
    {
        $mSearch = new Search();
        if ($params == null) {
            $params = array();
