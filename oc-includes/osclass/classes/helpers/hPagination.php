...
class Pagination
{
     ...
     */
    public static function osc_search_pagination()
    {
        $params = array();
     ...
     * @return string pagination links
     */
    public static function osc_comments_pagination()
    {
     ...
     * @return string
     */
    public static function osc_pagination_items($extraParams = array(), $field = false)
    {
     ...
     * @return string pagination links
     */
    public static function osc_pagination($params = null)
    {
        $pagination = new Pagination($params);
     ...
     * @param $aData
     */
    public static function osc_show_pagination_admin($aData)
    {
                ...
                <form method="get" action="<?php echo $urlActual; ?>" style="display:inline;">
                    ...
                    <ul>
                        ...
                        <li class="pagination-input">
                            <input id="gotoPage" type="text" name="iPage"
                                   value="<?php echo osc_esc_html($pageActual); ?>"/>
     ...
     * @return string
     */
    public static function osc_pagination_showing($from, $to, $filtered, $total = null)
    {
        if ($to == 0 || $filtered == 0) {
            $from = $to = $filtered = 0;
        }
