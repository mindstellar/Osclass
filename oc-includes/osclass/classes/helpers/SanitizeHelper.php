...
class SanitizeHelper
{
     ...
     */
    public static function osc_sanitize_url($value)
    {
     ...
     * @return string sanitized
     */
    public static function osc_sanitize_string($value)
    {
     ...
     * @return string sanitized
     */
    public static function osc_sanitize_name($value)
    {
     ...
     * @return string sanitized
     */
    public static function osc_sanitize_allcaps($value)
    {
     ...
     * @return string sanitized
     */
    public static function osc_sanitize_username($value)
    {
     ...
     * @return string sanitized
     */
    public static function osc_sanitize_int($value)
    {
     ...
     * @return string sanitized
     */
    public static function osc_sanitize_phone($value)
    {
        if (empty($value)) {
            return '';
        }
        ...
        if (!preg_match('/^[0-9]$/', $value)) {
            $value =
                preg_replace(
                    ...
                    '$1ext$3',
                    $value
                ); // Replace 'x|ext|extension' with 'ext'.
     ...
     * @version 2.4
     */
    public static function osc_esc_html($str = '')
    {
        if ($str === '') {
            return '';
        }
     ...
     * @version 2.4
     */
    public static function osc_esc_js($str)
    {
