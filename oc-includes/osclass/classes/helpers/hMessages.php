...
class hMessages
{
     ...
     * @return void
     */
    public static function osc_add_flash_message($msg, $section = 'pubMessages')
    {
     ...
     * @return void
     */
    public static function osc_add_flash_ok_message($msg, $section = 'pubMessages')
    {
     ...
     * @return void
     */
    public static function osc_add_flash_error_message($msg, $section = 'pubMessages')
    {
        Session::newInstance()->_setMessage($section, $msg, 'error');
    }
     ...
     * @return void
     */
    public static function osc_add_flash_info_message($msg, $section = 'pubMessages')
    {
     ...
     * @return void
     */
    public static function osc_add_flash_warning_message($msg, $section = 'pubMessages')
    {
     ...
     * @return void
     */
    public static function osc_show_flash_message(
        $section = 'pubMessages',
        $class = 'flashmessage',
        $id = 'flashmessage'
    ) {
     ...
     */
    public static function osc_get_flash_message($section = 'pubMessages', $dropMessages = true)
    {
