...
class ThemeHelper
{
     ...
     * @return string
     */
    public static function osc_admin_render_theme_url($file = '')
    {
     ...
     */
    public static function osc_render_file($file = '')
    {
        if ($file == '') {
            $file = __get('file');
        }
     ...
     * @return string
     */
    public static function osc_render_file_url($file = '')
    {
        osc_sanitize_url($file);
     ...
     */
    public static function osc_resend_flash_messages($section = 'pubMessages')
    {
     ...
     * @param string $id
     */
    public static function osc_enqueue_script($id)
    {
     ...
     * @param string $id
     */
    public static function osc_remove_script($id)
    {
     ...
     */
    public static function osc_register_script($id, $url, $dependencies = null)
    {
     ...
     * @param string $id
     */
    public static function osc_unregister_script($id)
    {
     ...
     */
    public static function osc_load_scripts()
    {
     ...
     */
    public static function osc_enqueue_style($id, $url)
    {
     ...
     * @param $id
     */
    public static function osc_remove_style($id)
    {
     ...
     */
    public static function osc_load_styles()
    {
     ...
     * @param string $class
     */
    public static function osc_print_bulk_actions($id, $name, $options, $class = '')
    {
...
/* file end: ./oc-includes/osclass/classes/helpers/Theme.php */
