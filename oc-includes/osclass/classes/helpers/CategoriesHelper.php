...
class CategoriesHelper
{
     ...
     * @return array
     */
    public static function osc_category()
    {
        $category = null;
    ...
    /**
     * Let you know if there are more categories in the list. If categories are not loaded, this function will load
     * them.
     *
     * @return boolean
     */
    ...
    /**
     * Gets the total of subcategories for the current category. If subcategories are not loaded, this function will
     * load them and it will prepare the the pointer to the first element
     *
     * @return int
     */
    ...
    /**
     * Let you know if there are more subcategories for the current category in the list. If subcategories are not
     * loaded, this function will load them and it will prepare the pointer to the first element
     *
     * @return boolean
     */
    ...
    /**
     * Gets the slug of the current category. WARNING: This slug could NOT be used as a valid W3C HTML tag attribute as
     * it could have other characters besides [A-Za-z0-9-_] We only did a urlencode to the variable
     *
     * @param string $locale
     *
     * @return string
