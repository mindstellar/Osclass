...
class hAdminMenu
{
     ...
     */
    public static function osc_draw_admin_menu()
    {
        // actual url
     ...
     * @param null   $position
     */
    public static function osc_add_admin_menu_page(
        $menu_title,
        $url,
        $menu_id,
     ...
     */
    public static function osc_remove_admin_menu()
    {
     ...
     * @param $menu_id
     */
    public static function osc_remove_admin_menu_page($menu_id)
    {
     ...
     * @param string $capability
     */
    public static function osc_add_admin_submenu_page(
        $menu_id,
        $submenu_title,
        $url,
        $submenu_id,
     ...
     * @param $submenu_id
     */
    public static function osc_remove_admin_submenu_page($menu_id, $submenu_id)
    {
     ...
     * @since 3.1
     */
    public static function osc_add_admin_submenu_divider($menu_id, $submenu_title, $submenu_id, $capability = null)
    {
     ...
     * @since 3.1
     */
    public static function osc_remove_admin_submenu_divider($menu_id, $submenu_id)
    {
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_items($submenu_title, $url, $submenu_id, $capability = null, $icon_url = null)
    {
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_categories(
        $submenu_title,
        $url,
        $submenu_id,
        $capability = null,
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_pages($submenu_title, $url, $submenu_id, $capability = null, $icon_url = null)
    {
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_appearance(
        $submenu_title,
        $url,
        $submenu_id,
        $capability = null,
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_plugins(
        $submenu_title,
        $url,
        $submenu_id,
        $capability = null,
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_settings(
        $submenu_title,
        $url,
        $submenu_id,
        $capability = null,
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_tools($submenu_title, $url, $submenu_id, $capability = null, $icon_url = null)
    {
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_users($submenu_title, $url, $submenu_id, $capability = null, $icon_url = null)
    {
     ...
     * @param null $icon_url
     */
    public static function osc_admin_menu_stats($submenu_title, $url, $submenu_id, $capability = null, $icon_url = null)
    {
     ...
     * @return string
     */
    public static function osc_current_menu()
    {
        $menu_id            = '';
        $current_menu       = 'dash';
        $something_selected = false;
