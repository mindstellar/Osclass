...
class hValidate
{
     ...
     * @return boolean
     */
    public static function osc_validate_text($value = '', $count = 1, $required = true)
    {
        if ($required || $value) {
     ...
     * @return boolean
     */
    public static function osc_validate_int($value)
    {
     ...
     * @return boolean
     */
    public static function osc_validate_nozero($value)
    {
     ...
     * @return boolean
     */
    public static function osc_validate_number($value = null, $required = false)
    {
        if ($required || $value != '') {
            if (!is_numeric($value)) {
                return false;
     ...
     * @return boolean
     */
    public static function osc_validate_phone($value = null, $count = 10, $required = false)
    {
        if ($required || $value != '') {
     ...
     * @return boolean
     */
    public static function osc_validate_min($value = null, $min = 6)
    {
     ...
     * @return boolean
     */
    public static function osc_validate_max($value = null, $max = 255)
    {
     ...
     * @return boolean
     */
    public static function osc_validate_range($value, $min = 6, $max = 255)
    {
     ...
     * @return boolean
     */
    public static function osc_validate_location($city, $sCity, $region, $sRegion, $country, $sCountry)
    {
     ...
     * @return boolean
     */
    public static function osc_validate_category($value)
    {
     ...
     * @return boolean
     */
    public static function osc_validate_url($value, $required = false, $get_headers = false)
    {
        if ($required || $value !== '') {
     ...
     * @return boolean
     */
    public static function osc_validate_spam_delay($type = 'item')
    {
        if ($type === 'item') {
     ...
     * @return boolean
     */
    public static function osc_validate_email($email, $required = true)
    {
        if ($required || $email !== '') {
     ...
     * @return bool
     */
    public static function osc_validate_username($value, $min = 1)
    {
