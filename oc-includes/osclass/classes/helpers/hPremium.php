...
////////////////////////////////////////////////////////////////
     ...
     */
    public static function osc_get_premiums($max = 2)
    {
     ...
     */
    public static function osc_premium()
    {
     ...
     * @return string
     */
    public static function osc_premium_field($field, $locale = '')
    {
...
///////////////////////
     ...
     * @return int
     */
    public static function osc_premium_id()
    {
     ...
     * @return int
     */
    public static function osc_premium_user_id()
    {
     ...
     * @return string $desc
     */
    public static function osc_premium_description($locale = '')
    {
        if ($locale == '') {
     ...
     * @return string
     */
    public static function osc_premium_title($locale = '')
    {
        if ($locale == '') {
            $locale = osc_current_user_locale();
        }
     ...
     * @return string
     */
    public static function osc_premium_category($locale = '')
    {
        if ($locale == '') {
            $locale = osc_current_user_locale();
        }
     ...
     * @return string
     */
    public static function osc_premium_category_description($locale = '')
    {
        if ($locale == '') {
            $locale = osc_current_user_locale();
        }
     ...
     * @return int
     */
    public static function osc_premium_category_id()
    {
     ...
     * @return string
     */
    public static function osc_premium_pub_date()
    {
     ...
     * @return string
     */
    public static function osc_premium_mod_date()
    {
     ...
     * @return float
     */
    public static function osc_premium_price()
    {
     ...
     * @return string
     */
    public static function osc_premium_formated_price()
    {
     ...
     * @since 3.0
     */
    public static function osc_premium_currency_symbol()
    {
     ...
     * @return string
     */
    public static function osc_premium_currency()
    {
     ...
     * @return string
     */
    public static function osc_premium_contact_name()
    {
     ...
     * @return string
     */
    public static function osc_premium_contact_email()
    {
     ...
     * @return string
     */
    public static function osc_premium_country()
    {
     ...
     * @return string
     */
    public static function osc_premium_country_code()
    {
     ...
     * @return string
     */
    public static function osc_premium_region()
    {
     ...
     * @return string
     */
    public static function osc_premium_city()
    {
     ...
     * @return string
     */
    public static function osc_premium_city_area()
    {
     ...
     * @return string
     */
    public static function osc_premium_address()
    {
     ...
     * @return boolean
     */
    public static function osc_premium_show_email()
    {
     ...
     * @return string
     */
    public static function osc_premium_zip()
    {
     ...
     * @return float
     */
    public static function osc_premium_latitude()
    {
     ...
     * @return float
     */
    public static function osc_premium_longitude()
    {
     ...
     * @return boolean
     */
    public static function osc_premium_is_premium()
    {
     ...
     * @return int
     */
    public static function osc_premium_views()
    {
        $item = osc_premium();
     ...
     * @return boolean
     */
    public static function osc_premium_status()
    {
     ...
     * @return string
     */
    public static function osc_premium_secret()
    {
     ...
     * @return boolean
     */
    public static function osc_premium_is_active()
    {
     ...
     * @return boolean
     */
    public static function osc_premium_is_inactive()
    {
     ...
     * @return boolean
     */
    public static function osc_premium_is_spam()
    {
     ...
     * @return int
     */
    public static function osc_premium_total_comments()
    {
     ...
     * @return int
     */
    public static function osc_premium_comments_page()
    {
...
/////////////
     ...
     * @return bool
     */
    public static function osc_has_premiums()
    {
     ...
     * @return array
     */
    public static function osc_reset_premiums()
    {
     ...
     * @return int
     */
    public static function osc_count_premiums()
    {
     ...
     * @return int
     */
    public static function osc_count_premium_resources()
    {
        if (!View::newInstance()->_exists('resources')) {
            View::newInstance()->_exportVariableToView(
                'resources',
     ...
     * @return bool
     */
    public static function osc_has_premium_resources()
    {
        if (!View::newInstance()->_exists('resources')) {
            View::newInstance()->_exportVariableToView(
                'resources',
     ...
     * @return array
     */
    public static function osc_get_premium_resources()
    {
        if (!View::newInstance()->_exists('resources')) {
            View::newInstance()->_exportVariableToView(
                'resources',
     ...
     * @return int
     */
    public static function osc_count_premium_comments()
    {
     ...
     * @return bool
     */
    public static function osc_has_premium_comments()
    {
        if (!View::newInstance()->_exists('comments')) {
            View::newInstance()->_exportVariableToView('comments', ItemComment::newInstance()
                ->findBypremiumID(
     ...
     * @return int
     */
    public static function osc_priv_count_premiums()
    {
        return (int)View::newInstance()->_count('premiums');
    }
     ...
     * @return integer
     */
    public static function osc_count_premium_meta()
    {
        if (!View::newInstance()->_exists('metafields')) {
            View::newInstance()->_exportVariableToView(
                'metafields',
     ...
     * @return bool
     */
    public static function osc_has_premium_meta()
    {
        if (!View::newInstance()->_exists('metafields')) {
            View::newInstance()->_exportVariableToView(
                'metafields',
     ...
     * @return array
     */
    public static function osc_get_premium_meta()
    {
        if (!View::newInstance()->_exists('metafields')) {
            View::newInstance()->_exportVariableToView(
                'metafields',
