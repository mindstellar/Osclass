...
class Security
{
     ...
     * @return string
     */
    public static function osc_genRandomPassword($length = 8)
    {
     ...
     * @since 3.1
     */
    public static function osc_csrf_token_form()
    {
     ...
     * @since 3.1
     */
    public static function osc_csrf_token_url()
    {
        list($name, $token) = osc_csrfguard_generate_token();
     ...
     * @since 3.1
     */
    public static function osc_csrf_check()
    {
        $error     = false;
        $str_error = '';
     ...
     * @since 3.1
     */
    public static function osc_is_banned($email = '', $ip = null)
    {
        if ($ip === null) {
     ...
     * @since 3.1
     */
    public static function osc_is_ip_banned($ip, $rules = null)
    {
        if ($rules === null) {
            $rules = BanRule::newInstance()->listAll();
        }
     ...
     * @since 3.1
     */
    public static function osc_is_email_banned($email, $rules = null)
    {
        if ($rules == null) {
            $rules = BanRule::newInstance()->listAll();
        }
     ...
     * @since 3.1
     */
    public static function osc_is_username_blacklisted($username)
    {
     ...
     * @since 3.3
     */
    public static function osc_verify_password($password, $hash)
    {
     ...
     * @since 3.3
     */
    public static function osc_hash_password($password)
    {
     ...
     * @return string
     */
    public static function osc_encrypt_alert($alert)
    {
     ...
     * @return string
     */
    public static function osc_decrypt_alert($string)
    {
        $key = hash('sha256', osc_get_alert_private_key(), true);
    ...
    public static function osc_set_alert_public_key()
    {
     ...
     * @return string
     */
    public static function osc_get_alert_public_key()
    {
        return Session::newInstance()->_get('alert_public_key');
    }


    public static function osc_set_alert_private_key()
    {
     ...
     * @return string
     */
    public static function osc_get_alert_private_key()
    {
     ...
     * @return bool|string
     */
    public static function osc_random_string($length)
    {
        $buffer       = '';
        $buffer_valid = false;
