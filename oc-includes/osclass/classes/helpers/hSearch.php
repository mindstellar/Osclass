...
class Search
{
     ...
     * @return mixed
     */
    public static function osc_search()
    {
     ...
     * @return array
     */
    public static function osc_list_orders()
    {
     ...
     * @return int
     */
    public static function osc_search_alert_subscribed()
    {
     ...
     * @return int
     */
    public static function osc_search_page()
    {
     ...
     * @return int
     */
    public static function osc_search_total_pages()
    {
     ...
     * @return boolean
     */
    public static function osc_search_has_pic()
    {
     ...
     * @return boolean
     */
    public static function osc_search_only_premium()
    {
     ...
     * @return string
     */
    public static function osc_search_order()
    {
     ...
     * @return string
     */
    public static function osc_search_order_type()
    {
     ...
     * @return string
     */
    public static function osc_search_pattern()
    {
     ...
     * @return string
     */
    public static function osc_search_country()
    {
     ...
     * @return string
     */
    public static function osc_search_region()
    {
     ...
     * @return string
     */
    public static function osc_search_city()
    {
     ...
     * @return array
     */
    public static function osc_search_user()
    {
     ...
     * @return float
     */
    public static function osc_search_price_max()
    {
     ...
     * @return float
     */
    public static function osc_search_price_min()
    {
     ...
     * @return int
     */
    public static function osc_search_total_items()
    {
     ...
     * @return string
     */
    public static function osc_search_show_as()
    {
     ...
     * @return int
     */
    public static function osc_search_start()
    {
     ...
     * @return int
     */
    public static function osc_search_end()
    {
     ...
     * @return array
     */
    public static function osc_search_category()
    {
     ...
     * @return array
     */
    public static function osc_search_category_id()
    {
     ...
     * @return string
     */
    public static function osc_update_search_url($params = array(), $forced = false)
    {
     ...
     * @return void
     */
    public static function osc_alert_form()
    {
     ...
     * @return string
     */
    public static function osc_search_alert()
    {
     ...
     * @return string
     */
    public static function osc_search_show_all_url($params = array())
    {
        $params['page'] = 'search';
     ...
     * @return string
     */
    public static function osc_search_url($params = null)
    {
        if (is_array($params)) {
     ...
     * @return array|mixed
     */
    public static function osc_remove_slash($var)
    {
        if (is_array($var)) {
            foreach ($var as $k => $v) {
     ...
     * @return array
     */
    public static function osc_list_country()
    {
     ...
     * @return array
     */
    public static function osc_list_region()
    {
     ...
     * @return array
     */
    public static function osc_list_city()
    {
     ...
     * @return array
     */
    public static function osc_has_list_countries()
    {
        if (!View::newInstance()->_exists('list_countries')) {
            View::newInstance()
     ...
     * @return array
     */
    public static function osc_has_list_regions($country = '%%%%')
    {
        if (!View::newInstance()->_exists('list_regions')) {
     ...
     * @return array
     */
    public static function osc_has_list_cities($region = '%%%%')
    {
        if (!View::newInstance()->_exists('list_cities')) {
            View::newInstance()
     ...
     * @return int
     */
    public static function osc_count_list_countries()
    {
        if (!View::newInstance()->_exists('list_countries')) {
            View::newInstance()
                ->_exportVariableToView('list_countries', CountryStats::newInstance()->listCountries());
     ...
     * @return int
     */
    public static function osc_count_list_regions($country = '%%%%')
    {
        if (!View::newInstance()->_exists('list_regions')) {
            View::newInstance()->_exportVariableToView(
                'list_regions',
     ...
     * @return int
     */
    public static function osc_count_list_cities($region = '%%%%')
    {
        if (!View::newInstance()->_exists('list_cities')) {
            View::newInstance()
                ->_exportVariableToView('list_cities', CityStats::newInstance()->listCities($region));
...
// country attributes
     ...
     * @return string
     */
    public static function osc_list_country_name()
    {
     ...
     * @return int
     */
    public static function osc_list_country_code()
    {
     ...
     * @return int
     */
    public static function osc_list_country_items()
    {
     ...
     * @return string
     */
    public static function osc_list_country_url()
    {
...
// region attributes
     ...
     * @return string
     */
    public static function osc_list_region_name()
    {
     ...
     * @return string
     */
    public static function osc_list_region_slug()
    {
        return osc_field(osc_list_region(), 'region_name', '');
    }
     ...
     * @return string
     */
    public static function osc_list_region_id()
    {
     ...
     * @return int
     */
    public static function osc_list_region_items()
    {
     ...
     * @return string
     */
    public static function osc_list_region_url()
    {
...
// city attributes
     ...
     * @return string
     */
    public static function osc_list_city_name()
    {
     ...
     * @return string
     */
    public static function osc_list_city_slug()
    {
     ...
     * @return string
     */
    public static function osc_list_city_id()
    {
     ...
     * @return int
     */
    public static function osc_list_city_items()
    {
     ...
     * @return string
     */
    public static function osc_list_city_url()
    {
     ...
     * @return array
     */
    public static function osc_get_latest_searches($limit = 20)
    {
     ...
     * @return int
     */
    public static function osc_count_latest_searches()
    {
        if (!View::newInstance()->_exists('latest_searches')) {
            View::newInstance()->_exportVariableToView(
                'latest_searches',
     ...
     * @return array
     */
    public static function osc_has_latest_searches()
    {
        if (!View::newInstance()->_exists('latest_searches')) {
            View::newInstance()->_exportVariableToView(
                'latest_searches',
     ...
     * @return array
     */
    public static function osc_latest_search()
    {
        if (View::newInstance()->_exists('latest_searches')) {
     ...
     * @return string
     */
    public static function osc_latest_search_text()
    {
     ...
     * @return string
     */
    public static function osc_latest_search_date()
    {
     ...
     * @return string
     */
    public static function osc_latest_search_total()
    {
     ...
     */
    public static function osc_get_canonical()
    {
     ...
     * @return mixed
     */
    public static function osc_get_raw_search($conditions)
    {
     ...
     * @return string
     */
    public static function _aux_search_category_slug($paramCat)
    {
