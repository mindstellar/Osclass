...
class Errors
{
     ...
     *
     */
    public static function osc_die($title, $message)
    {
        ?>
     ...
     * @return string
     */
    public static function getErrorParam($param, $htmlencode = false, $quotes_encode = true)
    {
        if ($param == '') {
            return '';
        }
     ...
     * @return string
     */
    public static function strip_slashes_extended_e($array)
    {
        if (is_array($array)) {
     ...
     * @return string
     */
    public static function osc_get_absolute_url()
    {
