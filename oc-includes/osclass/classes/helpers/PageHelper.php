...
class PageHelper
{
     ...
     * @return array
     */
    public static function osc_static_page()
    {
     ...
     * @return string
     */
    public static function osc_static_page_field($field, $locale = '')
    {
     ...
     * @return string
     */
    public static function osc_static_page_title($locale = '')
    {
        if ($locale == '') {
     ...
     * @return string
     */
    public static function osc_static_page_text($locale = '')
    {
        if ($locale == '') {
            $locale = osc_current_user_locale();
        }
     ...
     * @return string
     */
    public static function osc_static_page_id()
    {
     ...
     * @return int
     */
    public static function osc_static_page_order()
    {
     ...
     * @return string
     */
    public static function osc_static_page_mod_date()
    {
     ...
     * @return string
     */
    public static function osc_static_page_pub_date()
    {
     ...
     * @return string
     */
    public static function osc_static_page_slug()
    {
     ...
     * @return string
     */
    public static function osc_static_page_meta($field = null)
    {
        if (!View::newInstance()->_exists('page_meta')) {
     ...
     * @return string
     */
    public static function osc_static_page_url($locale = '')
    {
     ...
     * @return void
     */
    public static function osc_get_static_page($internal_name, $locale = '')
    {
        if ($locale == '') {
            $locale = osc_current_user_locale();
        }
     ...
     * @return int
     */
    public static function osc_count_static_pages()
    {
        if (!View::newInstance()->_exists('pages')) {
     ...
     * @return boolean
     */
    public static function osc_has_static_pages()
    {
        if (!View::newInstance()->_exists('pages')) {
     ...
     * @return void
     */
    public static function osc_reset_static_pages()
    {
