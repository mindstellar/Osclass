...
class Defines
{
     ...
     * @return string
     */
    public static function osc_base_url($with_index = false)
    {
        $path = WEB_PATH;
        if (MULTISITE) {
     ...
     * @return string
     */
    public static function osc_subdomain_base_url($params = array())
    {
     ...
     * @return string
     */
    public static function osc_admin_base_url($with_index = false)
    {
     ...
     * @return string
     */
    public static function osc_base_path()
    {
        return ABS_PATH;
    }
     ...
     * @return string
     */
    public static function osc_admin_base_path()
    {
     ...
     * @return string
     */
    public static function osc_lib_path()
    {
        return LIB_PATH;
    }
     ...
     * @return string
     */
    public static function osc_content_path()
    {
        return CONTENT_PATH;
    }
     ...
     * @return string
     */
    public static function osc_themes_path()
    {
        return THEMES_PATH;
    }
     ...
     * @return string
     */
    public static function osc_plugins_path()
    {
        return PLUGINS_PATH;
    }
     ...
     * @return string
     */
    public static function osc_translations_path()
    {
     ...
     * @return string
     */
    public static function osc_uploads_path()
    {
     ...
     * @return string
     */
    public static function osc_current_admin_theme()
    {
     ...
     * @return string
     */
    public static function osc_current_admin_theme_url($file = '')
    {
     ...
     * @return void
     */
    public static function osc_current_admin_theme_path($file = '')
    {
     ...
     * @return string
     */
    public static function osc_current_admin_theme_styles_url($file = '')
    {
     ...
     * @return string
     */
    public static function osc_current_admin_theme_js_url($file = '')
    {
     ...
     * @return string
     */
    public static function osc_current_web_theme()
    {
     ...
     * @return string
     */
    public static function osc_current_web_theme_url($file = '')
    {
     ...
     * @return void
     */
    public static function osc_current_web_theme_path($file = '')
    {
     ...
     * @return string
     */
    public static function osc_current_web_theme_styles_url($file = '')
    {
     ...
     * @return string
     */
    public static function osc_current_web_theme_js_url($file = '')
    {
     ...
     * @since 3.0
     */
    public static function osc_assets_url($file = '', $assets_base_url = null)
    {
     ...
     * @return string
     */
    public static function osc_contact_url()
    {
     ...
     * @return string
     */
    public static function osc_item_post_url_in_category()
    {
     ...
     * @return string
     */
    public static function osc_item_post_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     */
    public static function osc_search_category_url()
    {
     ...
     * @return string
     */
    public static function osc_user_dashboard_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_user_logout_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_user_login_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_register_account_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_user_activate_url($id, $code)
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_user_resend_activation_link($id, $email)
    {
     ...
     * @return string
     */
    public static function osc_item_comments_url($page = 'all', $locale = '')
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_comment_url($locale = '')
    {
     ...
     * @return string
     */
    public static function osc_item_url($locale = '')
    {
     ...
     *
     */
    public static function osc_item_url_from_item($item, $locale = '')
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_premium_url($locale = '')
    {
        if (osc_rewrite_enabled()) {
            $sanitized_categories = array();
     ...
     * @return string
     */
    public static function osc_item_url_ns($id, $locale = '')
    {
     ...
     * @return string
     */
    public static function osc_item_admin_edit_url($id)
    {
     ...
     * @return string
     */
    public static function osc_user_alerts_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_user_unsubscribe_alert_url($id = '', $email = '', $secret = '')
    {
        if ($secret == '') {
     ...
     * @return string
     */
    public static function osc_user_activate_alert_url($id, $secret, $email)
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_user_profile_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_user_list_items_url($page = '', $typeItem = '')
    {
        if (osc_rewrite_enabled()) {
            if ($page == '') {
     ...
     * @return string
     */
    public static function osc_change_user_email_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_change_user_username_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_change_user_email_confirm_url($userId, $code)
    {
        if (osc_rewrite_enabled()) {
            return osc_base_url() . osc_get_preference('rewrite_user_change_email_confirm') . '/' . $userId . '/'
                . $code;
        }
     ...
     * @return string
     */
    public static function osc_change_user_password_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_recover_user_password_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_forgot_user_password_confirm_url($userId, $code)
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_forgot_admin_password_confirm_url($adminId, $code)
    {
     ...
     * @return string
     */
    public static function osc_change_language_url($locale)
    {
        if (osc_rewrite_enabled()) {
...
/////////////////////////////////////
     ...
     * @return string
     */
    public static function osc_item_edit_url($secret = '', $id = '')
    {
        if ($id == '') {
            $id = osc_item_id();
        }
     ...
     * @return string
     */
    public static function osc_item_delete_url($secret = '', $id = '')
    {
        if ($id == '') {
            $id = osc_item_id();
        }
     ...
     * @return string
     */
    public static function osc_item_activate_url($secret = '', $id = '')
    {
        if ($id == '') {
            $id = osc_item_id();
        }
     ...
     * @return string
     */
    public static function osc_item_resource_delete_url($id, $item, $code, $secret = '')
    {
        if (osc_rewrite_enabled()) {
     ...
     * @return string
     */
    public static function osc_item_send_friend_url()
    {
        if (osc_rewrite_enabled()) {
     ...
     * @since 3.2
     */
    public static function osc_route_url($id, $args = array())
    {
     ...
     * @since 3.2
     */
    public static function osc_route_admin_url($id, $args = array())
    {
        $routes = Rewrite::newInstance()->getRoutes();
        if (!isset($routes[$id])) {
            return '';
     ...
     * @since 3.2
     */
    public static function osc_route_ajax_url($id, $args = array())
    {
        $routes = Rewrite::newInstance()->getRoutes();
        if (!isset($routes[$id])) {
            return '';
     ...
     * @since 3.2
     */
    public static function osc_route_admin_ajax_url($id, $args = array())
    {
        $routes = Rewrite::newInstance()->getRoutes();
        if (!isset($routes[$id])) {
            return '';
...
/////////////////////////////////////
     ...
     * @return array
     */
    public static function osc_get_countries()
    {
     ...
     * @return array|string
     */
    public static function osc_get_regions($country = '')
    {
     ...
     * @return array|string
     */
    public static function osc_get_cities($region = '')
    {
     ...
     * @return string
     */
    public static function osc_get_currencies()
    {
     ...
     * @return void
     */
    public static function osc_add_option_menu($option = null)
    {
        if ($option != null) {
     ...
     * @return boolean
     */
    public static function osc_is_home_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_search_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_static_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_contact_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_ad_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_publish_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_edit_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_item_contact_page()
    {
     ...
     */
    public static function osc_is_login_form()
    {
     ...
     * @return boolean
     */
    public static function osc_is_login_page()
    {
        return osc_is_current_page('login', '');
    }
     ...
     * @return boolean
     */
    public static function osc_is_register_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_recover_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_forgot_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_custom_page($value = null)
    {
     ...
     * @return boolean
     */
    public static function osc_is_public_profile()
    {
     ...
     * @return boolean
     */
    public static function osc_is_user_dashboard()
    {
     ...
     * @return boolean
     */
    public static function osc_is_user_profile()
    {
     ...
     * @return boolean
     */
    public static function osc_is_list_items()
    {
     ...
     * @return boolean
     */
    public static function osc_is_list_alerts()
    {
     ...
     * @return boolean
     */
    public static function osc_is_change_email_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_change_username_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_change_password_page()
    {
     ...
     * @return boolean
     */
    public static function osc_is_current_page($location, $section)
    {
     ...
     * @return boolean
     */
    public static function osc_is_404()
    {
     ...
     * @return string
     */
    public static function osc_get_osclass_location()
    {
     ...
     * @return string
     */
    public static function osc_get_osclass_section()
    {
     ...
     * @return boolean
     */
    public static function osc_is_moderator()
    {
     ...
     * @return mixed
     */
    public static function osc_get_domain()
    {
     ...
     * @return string|void
     */
    public static function osc_breadcrumb($separator = '&raquo;', $echo = true, $lang = array())
    {
     ...
     * @return mixed|string
     */
    public static function osc_subdomain_name()
    {
     ...
     * @return mixed|string
     */
    public static function osc_subdomain_slug()
    {
     ...
     * @return bool
     */
    public static function osc_is_subdomain()
    {
        return View::newInstance()->_get('subdomain_slug') != '';
    }
    /* file end: ./oc-includes/osclass/classes/helpers/Defines.php */
}
