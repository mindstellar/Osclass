...
class hLocation
{
     ...
     * @return array|string
     */
    public static function osc_country()
    {
     ...
     * @return array|string
     */
    public static function osc_region()
    {
     ...
     * @return array|string
     */
    public static function osc_city()
    {
     ...
     * @return array|string
     */
    public static function osc_city_area()
    {
     ...
     * @return bool
     */
    public static function osc_has_countries()
    {
        if (!View::newInstance()->_exists('countries')) {
     ...
     * @return bool
     */
    public static function osc_has_regions($country = '%%%%')
    {
        if (!View::newInstance()->_exists('regions')) {
            View::newInstance()
                ->_exportVariableToView('regions', RegionStats::newInstance()->listRegions($country, '>='));
        }
     ...
     * @return bool
     */
    public static function osc_has_cities($region = '%%%%')
    {
        if (!View::newInstance()->_exists('cities')) {
     ...
     * @return bool
     */
    public static function osc_has_city_areas($city = '%%%%')
    {
        if (!View::newInstance()->_exists('city_areas')) {
     ...
     * @return int
     */
    public static function osc_count_countries()
    {
        if (!View::newInstance()->_exists('contries')) {
            View::newInstance()
                ->_exportVariableToView(
                    'countries',
                    CountryStats::newInstance()->listCountries('>=', 'country_name ASC')
                );
        }
     ...
     * @return int
     */
    public static function osc_count_regions($country = '%%%%')
    {
        if (!View::newInstance()->_exists('regions')) {
            View::newInstance()->_exportVariableToView(
                'regions',
     ...
     * @return int
     */
    public static function osc_count_cities($region = '%%%%')
    {
        if (!View::newInstance()->_exists('cities')) {
            View::newInstance()->_exportVariableToView('cities', CityStats::newInstance()->listCities($region, '>='));
        }
     ...
     * @return int
     */
    public static function osc_count_city_areas($city = '%%%%')
    {
        if (!View::newInstance()->_exists('city_areas')) {
            View::newInstance()->_exportVariableToView(
                'city_areas',
     ...
     * @return string
     */
    public static function osc_country_name()
    {
     ...
     * @return int
     */
    public static function osc_country_items()
    {
     ...
     * @return array|string
     */
    public static function osc_region_name()
    {
     ...
     * @return int
     */
    public static function osc_region_items()
    {
     ...
     * @return string
     */
    public static function osc_city_name()
    {
     ...
     * @return int
     */
    public static function osc_city_items()
    {
     ...
     * @return string
     */
    public static function osc_city_area_name()
    {
     ...
     * @return int
     */
    public static function osc_city_area_items()
    {
     ...
     * @return string
     */
    public static function osc_country_url()
    {
     ...
     * @return string
     */
    public static function osc_region_url()
    {
     ...
     * @return string
     */
    public static function osc_city_url()
    {
     ...
     * @return string
     */
    public static function osc_city_area_url()
    {
