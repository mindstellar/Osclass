...
class UtilsHelper
{
     ...
     * @return mixed
     */
    public static function osc_get_param($key)
    {
     ...
     * @return string
     */
    public static function osc_field($item, $field, $locale)
    {
        if ($item !== null) {
            if ($locale == '') {
                if (isset($item[$field])) {
     ...
     * @return void
     */
    public static function osc_show_widgets($location)
    {
     ...
     * @return void
     */
    public static function osc_show_widgets_by_description($description)
    {
     ...
     * @return void
     */
    public static function osc_show_recaptcha($section = '')
    {
        if (osc_recaptcha_public_key()) {
            switch ($section) {
                case ('recover_password'):
                    ...
                    if ((time() - $time) <= 1200) {
                        echo _osc_recaptcha_get_html(osc_recaptcha_public_key(), substr(osc_language(), 0, 2))
                            . '<br />';
                    } else {
     ...
     * @return string
     */
    public static function osc_format_date($date, $dateformat = null)
    {
        if ($dateformat == null) {
     ...
     * @since 2.4
     */
    public static function osc_escape_string($string)
    {
     ...
     * @return void
     */
    public static function osc_private_user_menu($options = null)
    {
        if ($options == null) {
            $options   = array();
            $options[] = array(
            ...
            $options[] =
                array('name' => __('Dashboard'), 'url' => osc_user_dashboard_url(), 'class' => 'opt_dashboard');
            $options[] =
                array('name' => __('Manage your listings'), 'url' => osc_user_list_items_url(), 'class' => 'opt_items');
            $options[] =
                array('name' => __('Manage your alerts'), 'url' => osc_user_alerts_url(), 'class' => 'opt_alerts');
     ...
     * @return string
     */
    public static function osc_highlight($txt, $len = 300, $start_tag = '<strong>', $end_tag = '</strong>')
    {
        $txt = strip_tags($txt);
     ...
     *
     */
    public static function osc_get_http_referer()
    {
     ...
     * @param string $title
     */
    public static function osc_add_route(
        $id,
        $regexp,
        $url,
        $file,
     ...
     *
     */
    public static function osc_get_subdomain_params()
    {
        $options = array();
     ...
     * @return string
     */
    public static function osc_ganalytics_id()
    {
     ...
     * @return string
     */
    public static function osc_get_locations_json_url()
    {
     ...
     * @return string
     */
    public static function osc_get_locations_sql_url($location)
    {
     ...
     * @return string
     */
    public static function osc_get_languages_json_url()
    {
     ...
     * @return string
     */
    public static function osc_get_language_folder_url($language)
    {
     ...
     * @return array
     */
    public static function osc_get_language_files_urls($language)
    {
     ...
     * @param $lang
     */
    public static function _osc_recaptcha_get_html($siteKey, $lang)
    {
