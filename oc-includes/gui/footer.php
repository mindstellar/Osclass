...
<div id="footer">
    <div class="wrapper">
        ...
        <?php if ( osc_get_preference('footer_link', 'bender') !== '0') {
        ...
        <?php if ( osc_count_web_enabled_locales() > 1) { ?>
            ...
            <span><a id="<?php echo osc_locale_code(); ?>" href="<?php echo osc_change_language_url ( osc_locale_code() ); ?>"><?php echo osc_locale_name(); ?></a></span><?php if ( $i == 0 ) {
                echo ' &middot; ';
                         } ?>
                <?php $i++; ?>
            <?php } ?>
