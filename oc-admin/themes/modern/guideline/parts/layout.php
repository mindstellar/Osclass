<div id="#guideline-grid">
    ...
    <div class="grid-system">
        ...
        <div class="grid-row grid-30">
            <div class="row-wrapper">
                <p>The basic template includes the admin toolbar, the menu, and the basic layout to render your
                    page.</p>
            </div>
        </div>
        <div class="grid-row grid-30">
...
osc_add_hook(<span style="color:#666">'admin_page_header'</span>,<span style="color:#666">'customPageHeader'</span>);
    <span style="color:#ff5600">function</span> <span style="color:#21439c">customPageHeader</span>(){
        <span style="color:#45ae34;font-weight:700">echo</span> <span style="color:#666">'&lt;h1>'</span> <span
                            style="color:#069;font-weight:700">.</span> __(<span
                            style="color:#666">'Custom Layout'</span>) <span style="color:#069;font-weight:700">.</span> <span
                            style="color:#666">'&lt;/h1>'</span>;
    }
?>
