...
function customPageHeader()
{
    ...
    <h1><?php _e('Pages'); ?>
        ...
        <a href="<?php echo osc_admin_base_url(true); ?>?page=pages&amp;action=add"
           class="btn btn-green ico ico-32 ico-add-white float-right"><?php _e('Create page'); ?></a>
    </h1>
    <?php
}
...
?>
    <form id="dialog-page-delete" method="get" action="<?php echo osc_admin_base_url(true); ?>"
          class="has-form-actions hide" title="<?php echo osc_esc_html(__('Delete page')); ?>">
        <input type="hidden" name="page" value="pages"/>
